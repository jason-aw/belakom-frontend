<template>
  <div class="topicCard" @mouseover="hovered = true" @mouseleave="hovered = false" @click.stop="goToTopicDetail(topic.topicName)">
    ...
    <div class="deleteButtonArea">
      <transition name="deleteButtonFade">
        <b-button class="deleteButton" @click.stop="handleDeleteTopicSubmit(topic.id)" v-if="hovered"> delete </b-button>
      </transition>
    </div>
  </div>
</template>
